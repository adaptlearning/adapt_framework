module.exports = function(grunt) {
    ...
    grunt.registerTask('build',['insert-tracking-data', 'copy', 'concat', 'less', 'handlebars', 'bower', 'requirejs-bundle', 'requirejs:compile', 'create-json-config']);
    grunt.registerTask('dev', ['insert-tracking-data', 'copy', 'concat', 'less', 'handlebars', 'bower', 'requirejs-bundle', 'create-json-config', 'requirejs:dev']);
};