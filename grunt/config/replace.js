...
module.exports = function(grunt, options) {
  ...
  const generatePatterns = function() {
    ...
    try {
      ...
      if (!Object.prototype.hasOwnProperty.call(courseJson, 'description')) {
        courseJson.description = '';
      }

      // A shim for edge cases where xAPI has not been configured.
      if (!Object.prototype.hasOwnProperty.call(configJson, '_xapi')) {
        configJson._xapi = {
          _activityID: '',
          _isEnabled: false
        };
        ...
        if (Object.prototype.hasOwnProperty.call(configJson._xapi, '_activityID') && configJson._xapi._activityID === '') {
