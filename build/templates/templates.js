...
this["Handlebars"]["templates"]["helloWorld"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, functionType="function";


  buffer += "<div class=\"hello-world\">";
...
this["Handlebars"]["templates"]["basic"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"article-inner inner\"></div>";
  });
...
this["Handlebars"]["templates"]["nav"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  


  return "<div class=\"inner\">\n    <a href=\"#\" class=\"icon menu\" data-event=\"menu\" alt=\"Menu\" title=\"Menu\"></a>\n</div>";
  });
