...
**Important Note:** going forward we will no longer be developing for IE8, 9 & 10. If you need support for those browsers, please use [the legacy branch of Adapt](adaptlearning/adapt_framework/tree/legacy) instead.
