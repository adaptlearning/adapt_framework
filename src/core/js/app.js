...
require([
    ...
    'menu/menu',
    'theme/theme'
], function (BackboneModel, Adapt, Mediator, Drawer, Router, Device, PopupManager, Notify, NavigationView, AdaptCollection, ConfigModel, CourseModel, ContentObjectModel, ArticleModel, BlockModel, ComponentModel) {
